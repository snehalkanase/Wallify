...
const Tracks = ({ }) => {
    ...
    return (
        <div className="h-full">
            <Head>
                <title>{users ? `${users.display_name}'s wall` : 'Wallify'}</title>
                ...
                {isLoading ? (<div className="h-[40rem]">
                    ...
                    <div className='w-full min-h-[40rem]'>
                        ...
                        <div className="w-full flex flex-col justify-center items-center my-4" >
                            <p className={`mb-0 font-semibold italic ${selectedBackground.theme == 'light' && "text-black"}`} >wallify.vercel.app</p>
