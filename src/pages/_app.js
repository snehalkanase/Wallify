  ...
  return (
      <SessionProvider session={session}>
        <Head>
          ...
          <meta property="og:site_name" content="Wallify" />
          <meta name="twitter:title" content="Wallify" />
          ...
          <link rel="icon" href="/WallifySVG.svg" />
        </Head>
